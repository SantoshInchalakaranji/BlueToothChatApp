...
import com.prplmnstr.bluetoothchat.data.chat.mapper.toBluetoothDeviceDomain
import com.prplmnstr.bluetoothchat.data.chat.mapper.toByteArray
...
class AndroidBluetoothController(
    ...
    override suspend fun trySendMessage(message: String): BluetoothMessage? {
        ...
        if (dataTransferService == null) {
            Toast.makeText(context, "Please Connect to device and try again", Toast.LENGTH_SHORT)
                .show()
            return null
        }
